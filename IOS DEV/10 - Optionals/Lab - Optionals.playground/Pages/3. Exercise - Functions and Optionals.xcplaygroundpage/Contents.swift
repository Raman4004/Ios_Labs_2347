...
checkAge(userInputAge: "34e")
checkAge(userInputAge: "25")


//:  Go back and update your function to return the age as an integer. Will your function always return a value? Make sure your return type accurately reflects this. Call the function and print the return value.
let age1 = checkAge(userInputAge: "34e")
print("Returned age: \(age1)")

let age2 = checkAge(userInputAge: "25")
print("Returned age: \(age2)")
...
let price = getItemPrice(item: "Apple")
print("Price of Apple: \(String(describing: price))")

let price2 = getItemPrice(item: "Banana")
print("Price of Banana: \(String(describing: price2))")
/*:
